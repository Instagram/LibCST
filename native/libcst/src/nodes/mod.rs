...
pub(crate) mod deflated {
    ...
    pub use super::statement::{
        ...
        DeflatedTypeParamItem as TypeParamItem, DeflatedTypeParameters as TypeParameters,
        DeflatedTypeVar as TypeVar, DeflatedTypeVarTuple as TypeVarTuple, DeflatedWhile as While,
        DeflatedWith as With, DeflatedWithItem as WithItem,
    };
}
