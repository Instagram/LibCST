...
def is_value_of_type(  # noqa: C901 "too complex"
    ...
    # fall back to the default check.
        ...
        # pyre-fixme[6]: Expected `Union[typing.Type[typing.Any],
        #  typing.Tuple[typing.Union[typing.Type[typing.Any], typing.Tuple[typing.Any,
        #  ...]], ...]]` for 2nd param but got `Tuple[typing.Type[str],
        #  typing.Type[bytes], typing._SpecialForm]`.
