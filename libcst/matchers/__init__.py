...
class Module(BaseMatcherNode):
    ...
    path: Union[
        Optional[Path],
        MetadataMatchType,
        MatchIfTrue[Optional[Path]],
        DoNotCareSentinel,
        OneOf[Union[Optional[Path], MetadataMatchType, MatchIfTrue[Optional[Path]]]],
        AllOf[Union[Optional[Path], MetadataMatchType, MatchIfTrue[Optional[Path]]]],
    ] = DoNotCare()
    metadata: Union[
        MetadataMatchType,
        DoNotCareSentinel,
